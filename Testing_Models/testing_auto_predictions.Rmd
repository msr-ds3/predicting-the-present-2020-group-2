...
I was on trying to join grocery sales to this and applying lasso regularization to weed out the features that would be important to the model 
To use lasso regression we can use the glmnet function with alpha = 1

Reference used for implementation: https://daviddalpiaz.github.io/r4sl/regularization.html#lasso
